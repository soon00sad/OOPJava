...
public class BlockFactory {
    ...
    public BaseBlock getBlock(String blockName) throws BlocksException {
        ...
        try {
            ...
            log.log(Level.SEVERE, "Can not find class by name", e);
            throw new BlocksException("Can not find class by name", e);
        } catch (NoSuchMethodException e) {
            log.log(Level.SEVERE, "Can not find constructor in block " + blockName, e);
            throw new BlocksException("Can not find constructor in block", e);
        } catch (IllegalAccessException | InstantiationException | InvocationTargetException e) {
            log.log(Level.SEVERE, "Can not create new instance of " + blockName, e);
            throw new BlocksException("Can not create new instance of", e);
        }
        return newBlock;
    }
}
